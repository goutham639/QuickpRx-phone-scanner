...
var Kr = (o, d, p) => (Jr(o, d, "read from private field"), p ? p.call(o) : d.get(o));
var te = (o, d, p) => d.has(o) ? Zr("Cannot add the same private member more than once") : d instanceof WeakSet ? d.add(o) : d.set(o, p);
var re = (o, d, p, y) => (Jr(o, d, "write to private field"), y ? y.call(o, p) : d.set(o, p), p);
var ee = [
  "Aztec",
  "Codabar",
  "Code128",
...
var Bt = (() => {
  ...
  return function(p = {}) {
    ...
    function Ut(t) {
      var r;
      (r = c.onAbort) === null || r === void 0 || r.call(c, t), t = "Aborted(" + t + ")", nt(t), sr = true, t += ". Build with -sASSERTIONS for more info.";
    ...
    function yr(t, r, e2) {
      return Ae(t).then((n) => WebAssembly.instantiate(n, r)).then(e2, (n) => {
        nt(`failed to asynchronously prepare wasm: ${n}`), Ut(n);
      });
    }
    function Oe(t, r, e2, n) {
      return !t && typeof WebAssembly.instantiateStreaming == "function" && !pr(r) && typeof fetch == "function" ? fetch(r, {
        ...
        return i.then(n, function(u) {
          return nt(`wasm streaming compile failed: ${u}`), nt("falling back to ArrayBuffer instantiation"), yr(r, e2, n);
        });
      }) : yr(r, e2, n);
    }
    function xe() {
    ...
    var w = (t) => Br(t), $ = () => kr(), Ct = [], Tt = 0, Se = (t) => {
      var r = new Ht(t);
      return r.get_caught() || (r.set_caught(true), Tt--), r.set_rethrown(false), Ct.push(r), Vr(t), Ir(t);
    }, G = 0, je = () => {
      m(0, 0);
      var t = Ct.pop();
      Ur(t.excPtr), G = 0;
    ...
    class Ht {
      ...
      init(r, e2) {
        this.set_adjusted_ptr(0), this.set_type(r), this.set_destructor(e2);
      }
      set_adjusted_ptr(r) {
        E[this.ptr + 16 >> 2] = r;
      }
    ...
    var Fe = (t) => {
      ...
      var r = t.excPtr;
      throw t.get_rethrown() || (Ct.push(t), t.set_rethrown(true), t.set_caught(false), Tt++), G = r, G;
    }, Be = (t, r, e2) => {
      var n = new Ht(t);
      throw n.init(r, e2), G = t, Tt++, G;
    }, ke = () => Tt, Ue = () => {
      Ut("");
    }, Et = {}, zt = (t) => {
      for (; t.length; ) {
        var r = t.pop(), e2 = t.pop();
        e2(r);
      }
    };
    function ht(t) {
    ...
    var ot = {}, K = {}, _t = {}, mr, At = (t) => {
      ...
      var r = Et[t];
      delete Et[t];
      var e2 = r.rawConstructor, n = r.rawDestructor, a = r.fields, i = a.map((u) => u.getterReturnType).concat(a.map((u) => u.setterArgumentType));
      tt([t], i, (u) => {
        var s = {};
    ...
    var z = 8, Ne = (t, r, e2, n) => {
      ...
      var e2 = !!r.smartPtrType, n = !!r.smartPtr;
      return e2 !== n && At("Both smartPtrType and smartPtr must be specified"), r.count = {
        value: 1
      }, pt(Object.create(t, {
        $$: {
          value: r,
    ...
    function Ze(t) {
      ...
      var e2 = qe(this.registeredClass, r);
      if (e2 !== void 0) {
        if (e2.$$.count.value === 0)
          return e2.$$.ptr = r, e2.$$.smartPtr = t, e2.clone();
        var n = e2.clone();
      ...
      Object.assign(Dt.prototype, {
        isAliasOf(t) {
          if (!(this instanceof Dt) || !(t instanceof Dt))
            return false;
          var r = this.$$.ptrType.registeredClass, e2 = this.$$.ptr;
          t.$$ = t.$$;
          for (var n = t.$$.ptrType.registeredClass, a = t.$$.ptr; r.baseClass; )
            e2 = r.upcast(e2), r = r.baseClass;
          for (; n.baseClass; )
      ...
      if (t[r].overloadTable === void 0) {
        ...
        t[r] = function() {
          for (var a = arguments.length, i = new Array(a), u = 0; u < a; u++)
            i[u] = arguments[u];
          return t[r].overloadTable.hasOwnProperty(i.length) || C(`Function '${e2}' called with an invalid number of arguments (${i.length}) - expects one of (${t[r].overloadTable})!`), t[r].overloadTable[i.length].apply(this, i);
        }, t[r].overloadTable = [], t[r].overloadTable[n.argCount] = n;
      }
    }, Xt = (t, r, e2) => {
      c.hasOwnProperty(t) ? ((e2 === void 0 || c[t].overloadTable !== void 0 && c[t].overloadTable[e2] !== void 0) && C(`Cannot register public name '${t}' twice`), Pr(c, t, t), c.hasOwnProperty(e2) && C(`Cannot register multiple overloads of a function with the same number of arguments (${e2})!`), c[t].overloadTable[e2] = r) : (c[t] = r, e2 !== void 0 && (c[t].numArguments = e2));
    }, tn = 48, rn = 57, en = (t) => {
      t = t.replace(/[^a-zA-Z0-9_]/g, "$");
      var r = t.charCodeAt(0);
      return r >= tn && r <= rn ? `_${t}` : t;
    };
    function nn(t, r, e2, n, a, i, u, s) {
      this.name = t, this.constructor = r, this.instancePrototype = e2, this.rawDestructor = n, this.baseClass = a, this.getActualType = i, this.upcast = u, this.downcast = s, this.pureVirtualFunctions = [];
    }
    var Qt = (t, r, e2) => {
      for (; r !== e2; )
        r.upcast || C(`Expected null or instance of ${e2.name}, got an instance of ${r.name}`), t = r.upcast(t), r = r.baseClass;
      return t;
    };
    function an(t, r) {
      if (r === null)
      ...
      var e2 = r.$$.ptrType.registeredClass, n = Qt(r.$$.ptr, e2, this.registeredClass);
      return n;
    }
    function on(t, r) {
      var e2;
      ...
      if (e2 = Qt(r.$$.ptr, n, this.registeredClass), this.isSmartPointer)
        switch (r.$$.smartPtr === void 0 && C("Passing raw pointer to smart pointer is illegal"), this.sharingPolicy) {
          case 0:
            r.$$.smartPtrType === this ? e2 = r.$$.smartPtr : C(`Cannot convert argument of type ${r.$$.smartPtrType ? r.$$.smartPtrType.name : r.$$.ptrType.name} to parameter type ${this.name}`);
            break;
          case 1:
            e2 = r.$$.smartPtr;
            break;
    ...
    function St(t, r, e2, n, a, i, u, s, l, f, h) {
      this.name = t, this.registeredClass = r, this.isReference = e2, this.isConst = n, this.isSmartPointer = a, this.pointeeType = i, this.sharingPolicy = u, this.rawGetPointee = s, this.rawConstructor = l, this.rawShare = f, this.rawDestructor = h, !a && r.baseClass === void 0 ? n ? (this.toWireType = an, this.destructorFunction = null) : (this.toWireType = sn, this.destructorFunction = null) : this.toWireType = on;
    }
    var Er = (t, r, e2) => {
      c.hasOwnProperty(t) || At("Replacing nonexistent public symbol"), c[t].overloadTable !== void 0 && e2 !== void 0 ? c[t].overloadTable[e2] = r : (c[t] = r, c[t].argCount = e2);
    }, cn = (t, r, e2) => {
      t = t.replace(/p/g, "i");
      var n = c["dynCall_" + t];
      return n(r, ...e2);
...
` + a.replace(/^Error(:[^\n]*)?\n/, ""));
      ...
      throw r.forEach(a), new Ar(`${t}: ` + e2.map(Or).join([", "]));
    }, hn = (t, r, e2, n, a, i, u, s, l, f, h, v, g) => {
    ...
    function qt(t, r, e2, n, a, i) {
      var u = r.length;
      u < 2 && C("argTypes array size mismatch! Must at least get return value and 'this' types!");
      var s = r[1] !== null && e2 !== null, l = pn(r), f = r[0].name !== "void", h = u - 2, v = new Array(h), g = [], T = [], _ = function() {
        T.length = 0;
        var S;
    ...
    var vn = (t, r, e2, n, a, i) => {
      ...
      r = j(r), r = xr(r), i = U(a, i), tt([], [t], (v) => {
        ...
        return S === void 0 || S.overloadTable === void 0 && S.className !== v.name && S.argCount === e2 - 2 ? (T.argCount = e2 - 2, T.className = v.name, _[r] = T) : (Pr(_, r, g), _[r].overloadTable[e2 - 2] = T), tt([], h, (O) => {
          var x = qt(g, O, v, i, u);
          return _[r].overloadTable === void 0 ? (x.argCount = e2 - 2, _[r] = x) : _[r].overloadTable[e2 - 2] = x, [];
        }), [];
      });
    }, Zt = [], X = [], Jt = (t) => {
      ...
      a.values = {}, k(t, {
        ...
        argPackAdvance: z,
        readValueFromPointer: $n(r, e2, n),
        destructorFunction: null
      }), Xt(r, a);
    }, Kt = (t, r) => {
      var e2 = K[t];
      return e2 === void 0 && C(`${r} has unknown type ${Or(t)}`), e2;
    }, Cn = (t, r, e2) => {
      var n = Kt(t, "enum");
      r = j(r);
      ...
      s ? f = function(h, v) {
        ...
        toWireType: f,
        argPackAdvance: z,
        readValueFromPointer: _n(r, e2, n !== 0),
        destructorFunction: null
      });
    }, On = (t, r, e2) => {
      ...
      for (var a = e2, i = e2 + n - 1, u = 0; u < t.length; ++u) {
        ...
        if (s <= 127) {
          ...
          if (e2 + 1 >= i) break;
          r[e2++] = 192 | s >> 6, r[e2++] = 128 | s & 63;
        } else if (s <= 65535) {
          if (e2 + 2 >= i) break;
          r[e2++] = 224 | s >> 12, r[e2++] = 128 | s >> 6 & 63, r[e2++] = 128 | s & 63;
        } else {
          if (e2 + 3 >= i) break;
          r[e2++] = 240 | s >> 18, r[e2++] = 128 | s >> 12 & 63, r[e2++] = 128 | s >> 6 & 63, r[e2++] = 128 | s & 63;
        }
      }
      return r[e2] = 0, e2 - a;
    }, yt = (t, r, e2) => Sn(t, F, r, e2), jn = (t) => {
      for (var r = 0, e2 = 0; e2 < t.length; ++e2) {
        var n = t.charCodeAt(e2);
        n <= 127 ? r++ : n <= 2047 ? r += 2 : n >= 55296 && n <= 57343 ? (r += 4, ++e2) : r += 3;
      }
      return r;
    }, Sr = typeof TextDecoder < "u" ? new TextDecoder() : void 0, jr = function(t) {
      let r = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : 0, e2 = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : NaN;
      for (var n = r + e2, a = r; t[a] && !(a >= n); ) ++a;
      ...
      for (var e2 = t, n = e2 >> 1, a = n + r / 2; !(n >= a) && ft[n]; ) ++n;
      ...
      e2 -= 2;
      for (var a = r, i = e2 < t.length * 2 ? e2 / 2 : t.length, u = 0; u < i; ++u) {
        var s = t.charCodeAt(u);
        at[r >> 1] = s, r += 2;
      }
      return at[r >> 1] = 0, r - a;
    }, Rn = (t) => t.length * 2, Bn = (t, r) => {
      for (var e2 = 0, n = ""; !(e2 >= r / 4); ) {
        var a = Z[t + e2 * 4 >> 2];
        if (a == 0) break;
        if (++e2, a >= 65536) {
          var i = a - 65536;
      ...
      for (var a = r, i = a + e2 - 4, u = 0; u < t.length; ++u) {
        var s = t.charCodeAt(u);
        if (s >= 55296 && s <= 57343) {
          var l = t.charCodeAt(++u);
          s = 65536 + ((s & 1023) << 10) | l & 1023;
    ...
    }, Nn = (t, r, e2) => F.copyWithin(t, r, r + e2), rr = [], Gn = (t, r, e2, n) => (t = rr[t], r = Q.toValue(r), t(null, r, e2, n)), Xn = {}, Qn = (t) => {
      var r = Xn[t];
      ...
      function t(r) {
        r.$$$embind_global$$$ = r;
        var e2 = typeof $$$embind_global$$$ == "object" && r.$$$embind_global$$$ == r;
        return e2 || delete r.$$$embind_global$$$, e2;
      }
      ...
      for (var e2 = new Array(t), n = 0; n < t; ++n)
        e2[n] = Kt(E[r + n * 4 >> 2], "parameter " + n);
      return e2;
    }, Jn = Reflect.construct, Kn = (t, r, e2) => {
      ...
      var e2 = t.readValueFromPointer(r);
      ...
      var r = $t.buffer, e2 = (t - r.byteLength + 65535) / 65536 | 0;
      try {
      ...
      if (!mt.strings) {
        ...
        for (var e2 in er)
          er[e2] === void 0 ? delete r[e2] : r[e2] = er[e2];
        var n = [];
        for (var e2 in r)
          n.push(`${e2}=${r[e2]}`);
        mt.strings = n;
      ...
      E[t >> 2] = e2.length;
      var n = 0;
      return e2.forEach((a) => n += a.length + 1), E[r >> 2] = n, 0;
    }, ha = (t) => 52;
    function pa(t, r, e2, n, a) {
      return 70;
    }
    var va = [null, [], []], ya = (t, r) => {
      var e2 = va[t];
      r === 0 || r === 10 ? ((t === 1 ? kt : nt)(jr(e2)), e2.length = 0) : e2.push(r);
    }, ma = (t, r, e2, n) => {
    ...
    var wa = {
      ...
      G: Za,
      A: ga
    }, A = De(), Wr = (t) => (Wr = A.Ba)(t), Y = c._free = (t) => (Y = c._free = A.Ca)(t), nr = c._malloc = (t) => (nr = c._malloc = A.Ea)(t), Ir = (t) => (Ir = A.Fa)(t), m = (t, r) => (m = A.Ga)(t, r), Rr = (t) => (Rr = A.Ha)(t), Br = (t) => (Br = A.Ia)(t), kr = () => (kr = A.Ja)(), Ur = (t) => (Ur = A.Ka)(t), Vr = (t) => (Vr = A.La)(t), Hr = (t, r, e2) => (Hr = A.Ma)(t, r, e2);
    c.dynCall_viijii = (t, r, e2, n, a, i, u) => (c.dynCall_viijii = A.Na)(t, r, e2, n, a, i, u);
    var Lr = c.dynCall_jiii = (t, r, e2, n) => (Lr = c.dynCall_jiii = A.Oa)(t, r, e2, n);
    c.dynCall_jiji = (t, r, e2, n, a) => (c.dynCall_jiji = A.Pa)(t, r, e2, n, a);
    var zr = c.dynCall_jiiii = (t, r, e2, n, a) => (zr = c.dynCall_jiiii = A.Qa)(t, r, e2, n, a);
    c.dynCall_iiiiij = (t, r, e2, n, a, i, u) => (c.dynCall_iiiiij = A.Ra)(t, r, e2, n, a, i, u), c.dynCall_iiiiijj = (t, r, e2, n, a, i, u, s, l) => (c.dynCall_iiiiijj = A.Sa)(t, r, e2, n, a, i, u, s, l), c.dynCall_iiiiiijj = (t, r, e2, n, a, i, u, s, l, f) => (c.dynCall_iiiiiijj = A.Ta)(t, r, e2, n, a, i, u, s, l, f);
    function $a(t, r) {
      var e2 = $();
      try {
        return b(t)(r);
    ...
    function Aa(t) {
      ...
      try {
        ...
        if (w(r), e2 !== e2 + 0) throw e2;
        m(1, 0);
      }
    }
    function Oa(t, r, e2, n, a, i, u, s, l, f, h) {
      var v = $();
      try {
        b(t)(r, e2, n, a, i, u, s, l, f, h);
      } catch (g) {
        if (w(v), g !== g + 0) throw g;
        m(1, 0);
      }
    }
    function xa(t, r, e2, n, a) {
      var i = $();
      try {
        b(t)(r, e2, n, a);
      } catch (u) {
    ...
    function Sa(t, r, e2, n, a, i) {
      var u = $();
      try {
        return b(t)(r, e2, n, a, i);
      } catch (s) {
        if (w(u), s !== s + 0) throw s;
        m(1, 0);
      }
    }
    function ja(t, r, e2, n, a, i) {
      var u = $();
      try {
        b(t)(r, e2, n, a, i);
      } catch (s) {
    ...
    function Fa(t, r, e2, n, a, i, u) {
      var s = $();
      try {
        return b(t)(r, e2, n, a, i, u);
      } catch (l) {
        if (w(s), l !== l + 0) throw l;
        m(1, 0);
      }
    }
    function Ma(t, r, e2, n, a, i, u, s) {
      var l = $();
      try {
        b(t)(r, e2, n, a, i, u, s);
      } catch (f) {
    ...
    function Wa(t, r, e2, n, a, i, u, s, l) {
      var f = $();
      try {
        b(t)(r, e2, n, a, i, u, s, l);
      } catch (h) {
    ...
    function Ra(t, r, e2, n, a, i, u, s, l) {
      var f = $();
      try {
        return b(t)(r, e2, n, a, i, u, s, l);
      } catch (h) {
        if (w(f), h !== h + 0) throw h;
        m(1, 0);
      }
    }
    function Ba(t, r, e2, n, a, i, u) {
      var s = $();
      try {
        return b(t)(r, e2, n, a, i, u);
      } catch (l) {
    ...
    function La(t, r, e2, n, a, i, u, s, l, f) {
      var h = $();
      try {
        return b(t)(r, e2, n, a, i, u, s, l, f);
      } catch (v) {
    ...
    function Ga(t, r, e2, n, a, i, u, s, l, f) {
      var h = $();
      try {
        b(t)(r, e2, n, a, i, u, s, l, f);
      } catch (v) {
        if (w(h), v !== v + 0) throw v;
        m(1, 0);
      }
    }
    function Xa(t, r, e2, n, a, i, u, s) {
      var l = $();
      try {
        return b(t)(r, e2, n, a, i, u, s);
      } catch (f) {
        if (w(l), f !== f + 0) throw f;
        m(1, 0);
      }
    }
    function Qa(t, r, e2, n, a, i, u) {
      var s = $();
      try {
        b(t)(r, e2, n, a, i, u);
      } catch (l) {
    ...
    function qa(t, r, e2, n, a, i, u, s, l, f, h, v) {
      var g = $();
      try {
        return b(t)(r, e2, n, a, i, u, s, l, f, h, v);
      } catch (T) {
        if (w(g), T !== T + 0) throw T;
        m(1, 0);
      }
    }
    function Za(t, r, e2, n, a, i, u, s, l, f, h, v, g, T, _, S) {
      var O = $();
      try {
        b(t)(r, e2, n, a, i, u, s, l, f, h, v, g, T, _, S);
      } catch (x) {
        if (w(O), x !== x + 0) throw x;
        m(1, 0);
      }
    }
    function Ja(t, r, e2, n) {
      var a = $();
      try {
        return Lr(t, r, e2, n);
      } catch (i) {
    ...
    function Ka(t, r, e2, n, a) {
      var i = $();
      try {
        return zr(t, r, e2, n, a);
      } catch (u) {
        if (w(i), u !== u + 0) throw u;
        m(1, 0);
      }
